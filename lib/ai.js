...
async function handleMessageLocal(content, sock, sender, remoteJid, messageType, session, message, pushName) {
...
async function processMessage(content, sock, sender, remoteJid, message, messageType, pushName) {
    const session = getSession(sender);

    const AiInternal = await handleMessageLocal(content, sock, sender, remoteJid, messageType, session, message, pushName);
    let rule_;
